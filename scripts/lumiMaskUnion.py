...
try:
    ...
    print
    print( "ERROR: Could not load LumiList.  Please execute this script in a cmssw environment with python3.")
    exit(-1)
...
# )
#XXX this seems broken in CMSSW_12_6_5
...
#lumiListUL2016selected = copy.deepcopy(originalLumiList1)
#lumiListUL2016selected.selectRuns(runs2016Bver1+runs2016Bver2+runs2016C+runs2016D+runs2016E+runs2016F)
#print("Writing JSON...",)
#lumiListUL2016selected.writeJSON("certified_UL2016BCDEF.json")
#print("Done")
...
lumiListUL2016selected = copy.deepcopy(originalLumiList1)
#runs2016D_noDoubleEle_MWTrigger = [276453, 276454, 276458, 276495, 276501, 276502, 276525, 276527, 276528, 276542, 276543, 276544, 276545, 276581, 276582, 276583, 276584, 276585, 276586, 276587, 276653, 276655, 276659, 276775, 276776, 276794, 276807, 276808, 276810, 276811]
##runs2016E
##runs2016F
#lumiListUL2016selected.selectRuns(runs2016D_noDoubleEle_MWTrigger + runs2016E + runs2016F) #+ runs2016F_noHIPM + runs2016G_noDoubleEle_MWTrigger)
#print("Writing JSON...",)
#lumiListUL2016selected.writeJSON("certified_UL2016preVFP_noMWTrigger.json")
#print("Done")

runs2016F_noHIPM = [278769, 278801, 278802, 278803, 278804, 278805, 278808]
runs2016G_noDoubleEle_MWTrigger = [278820, 278821, 278822]
lumiListUL2016selected.selectRuns(runs2016F_noHIPM + runs2016G_noDoubleEle_MWTrigger)
print("Writing JSON...",)
lumiListUL2016selected.writeJSON("certified_UL2016postVFP_noMWTrigger.json")
print("Done")
