...
#declare -a years=("2016preVFP" "2016postVFP" "2018")
...
inputLists[2016preVFP]="config/inputListsNanoAOD_nanoV9_UL2016_preVFP/inputListDataOnly.txt"
inputLists[2016postVFP]="config/inputListsNanoAOD_nanoV9_UL2016_postVFP/inputListDataOnly.txt"
inputLists[2017]="config/inputListsNanoAOD_nanoV9_UL2017/inputListDataOnly.txt"
inputLists[2018]="config/inputListsNanoAOD_nanoV9_UL2018/inputListDataOnly.txt"
...
for year in "${years[@]}" ; do
    ...
    echo "python3 scripts/launchAnalysis_batch_ForSkimToEOS.py -j ${nMaxJobs} -i ${inputList} -o ${localStorageDir}/${year}/rskQCD_heep_${skimNameSuffix} -n Events -e build/main -d ${eosStorageDir}/${year}/rskQCD_heep_${skimNameSuffix} -c ${cutFile} -r"
    python3 scripts/launchAnalysis_batch_ForSkimToEOS.py -j ${nMaxJobs} -i ${inputList} -o ${localStorageDir}/${year}/rskQCD_heep_${skimNameSuffix} -n Events -e build/main -d ${eosStorageDir}/${year}/rskQCD_heep_${skimNameSuffix} -c ${cutFile} -r
    retVal=$?
    if [ $retVal -ne 0 ]; then
...
for year in "${years[@]}" ; do
    ...
    echo "python3 scripts/launchAnalysis_batch_ForSkimToEOS.py -j ${nMaxJobs} -i ${inputList} -o ${localStorageDir}/${year}/rskDoubleEle_heep_${skimNameSuffix} -n Events -e build/main -d ${eosStorageDir}/${year}/rskDoubleEle_heep_${skimNameSuffix} -c ${cutFile} -r"
    python3 scripts/launchAnalysis_batch_ForSkimToEOS.py -j ${nMaxJobs} -i ${inputList} -o ${localStorageDir}/${year}/rskDoubleEle_heep_${skimNameSuffix} -n Events -e build/main -d ${eosStorageDir}/${year}/rskDoubleEle_heep_${skimNameSuffix} -c ${cutFile} -r
    retVal=$?
    if [ $retVal -ne 0 ]; then
