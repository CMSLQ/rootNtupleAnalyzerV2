...
makeTrainingTrees=true
doTraining=false
doOptimization=false
doBDTPlots=false
years='2016preVFP 2016postVFP 2018' # '2016preVFP 2016postVFP 2017 2018'
skimDate='16sep'
...
destDir=$LQDATAEOS/BDT_19AugSkim/LQToDEle/allYears/Meejjj/removeMeejj
#destDir=testingBDTs
#rm -r dataset
