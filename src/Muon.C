...
float Muon::PFRelIso04                (){ return m_collection->ReadArrayBranch<Float_t>("Muon_pfRelIso04_all", m_raw_index); }
bool  Muon::PassPFRelIsoLoose         (){ return m_collection->ReadArrayBranch<UChar_t>("Muon_pfIsoId", m_raw_index)==2; } 
